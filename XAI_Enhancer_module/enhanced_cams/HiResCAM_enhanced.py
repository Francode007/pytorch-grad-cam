...
class HiResCAMEnhanced(BaseCAM):
    def __init__(self, 
                model, 
                target_layers,
                reshape_transform=None):
        super(HiResCAMEnhanced, self).__init__(model, target_layers, reshape_transform)
    ...
    def get_cam_image(self, 
        ...
        # HiResCAM uses element-wise multiplication
        ...
        ### normalize the elementwise_activations and create masked_activations
        masked_activations = self.normalize_and_mask_activations(elementwise_activations, activations)
